...
public class Boss1 extends Enemy {
    ...
    public Boss1(float x, float y, float width, float height, int score, int maxHealth, Player player, ArrayList<Bullet> bullets, ArrayList<Light2D> lights) {
        super(x, y, width, height, score, maxHealth, player, lights);
